...
#define PES_STRTYP_MPEG2AAC     0x0F
#define PES_STRTYP_14496VIDEO   0x10
#define PES_STRTYP_14496AUDIO   0x11
#define PES_STRTYP_14496GENERIC 0x12
#define PES_STRTYP_14496SLPACK  0x13
#define PES_STRTYP_13818SYNCDLP 0x14
#define PES_STRTYP_H264VIDEO    0x1B
#define PES_STRTYP_VIDEODIGIC2  0x80
#define PES_STRTYP_AUDIOATSCAC3 0x81
#define PES_STRTYP_AUDIOHDMVDTS 0x82
#define PES_STRTYP_AUDIOLPCM    0x83
#define PES_STRTYP_AUDIOSDDS    0x84
#define PES_STRTYP_ATSCPROGID   0x85
#define PES_STRTYP_AUDIODTSHD   0x86
#define PES_STRTYP_AUDIOEAC3    0x87
#define PES_STRTYP_AUDIODTS     0x8A
#define PES_STRTYP_AUDIOA52BAC3 0x91

#define streamtype_isvideo(typ) \
  ((typ == PES_STRTYP_VIDEO11172) || \
   (typ == PES_STRTYP_VIDEO13818) || \
   (typ == PES_STRTYP_14496VIDEO) || \
   (typ == PES_STRTYP_H264VIDEO))

#define streamtype_isaudio(typ) \
  ((typ == PES_STRTYP_AUDIO11172) || \
   (typ == PES_STRTYP_AUDIO13818) || \
   (typ == PES_STRTYP_14496AUDIO))
